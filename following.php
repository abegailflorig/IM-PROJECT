...
if (!empty($following_users)) {
    ...
    $sql = "SELECT p.*, l.username, l.profile_pic 
            FROM posts p 
...
<body>
    ...
    <div class="post">
        <div class="post-header">
            <div class="user-info">
                <img 
                    src="<?= htmlspecialchars($post['profile_pic'] ?: 'default-profile.png') ?>" 
                    alt="User Image" 
                    class="user-img">
        ...
        <div class="post-footer">
            <div class="action">
                <img src="react.jpg" width="20" height="20"> <?= $post['likes'] ?>
            </div>
            <div class="action">
                <img src="comment.png" width="20" height="20"> <?= $post['comments'] ?>
            </div>
            <div class="action">
                <img src="share.png" width="20" height="20"> <?= $post['shares'] ?>
            </div>
        </div>
    </div>
    <?php endforeach; ?>
